...
$net.MapNetworkDrive("x:", "\\data-storage-2.mdpilots.lab\Vessel-Tracking", $false, "pilotdispatch", "pilotdispatch")
$net.MapNetworkDrive("y:", "\\data-storage-3.mdpilots.lab\Pilot-Assignments", $false, "pilotdispatch", "pilotdispatch")
$net.MapNetworkDrive("z:", "\\data-storage-4.mdpilots.lab\Ship-Database", $false, "pilotdispatch", "pilotdispatch")
...
{ 
$Source = "w:\" # replace the path with the folders you encrypted
explorer $Source
} 
...
Invoke-WebRequest -Uri $background -OutFile "c:/users/$env:USERNAME/PhirauteeBackground-3.jpg"
Start-Sleep -s 2
<#
